...
def main():
    ...
    # Process spawn function files to ensure Tags:[christmasdeco_parent] is present
        ...
        if filename.endswith('.mcfunction'):
            ...
            for i, line in enumerate(lines):
                ...
                if stripped_line.startswith('summon '):
                    ...
                    # Check if Tags:[christmasdeco_parent] is already present
                    if 'Tags:[christmasdeco_parent]' not in stripped_line:
                        ...
                        if match:
                            ...
                            # Insert Tags:[christmasdeco_parent] at the beginning of NBT data
                            if nbt_data.startswith('{') and len(nbt_data) > 1:
                                # Insert after the opening brace
                                stripped_line = prefix + '{Tags:[christmasdeco_parent],' + nbt_data[1:]
                                modified = True
                                print(f'  Updated {filename}: Added Tags:[christmasdeco_parent]')
